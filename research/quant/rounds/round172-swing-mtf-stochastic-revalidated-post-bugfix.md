...
SMA-50 trend agreement) was found in `research/quant/studies/portfolio-btc-optimization-log.md`
...
`docs/reviews/kline-stream-gate-capacity-saga.md`), all with `--days 1825`
...
`docs/archive/legacy-handoff-agent.md`'s Round 17 Todo item (swing family as a trend
