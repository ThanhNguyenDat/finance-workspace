...
`docs/archive/legacy-raw/proposal/portfolio-profitability-improvements.md` Round 2 cho BTC.
...
xem `research/quant/rounds/round17-swing-4h1d-regime-filter-family.md`):
...
2. **`holdout_interval_continuity` fail thật** — đây là lỗi dữ liệu, không
   ...
   gộp thành 1 Todo item duy nhất trong `docs/archive/legacy-handoff-agent.md` thay vì để 2
