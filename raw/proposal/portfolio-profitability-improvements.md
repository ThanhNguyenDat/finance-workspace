...
three shipped (`raw/archive/closed-2026-08/portfolio-strategy-attribution.md`,
`raw/archive/closed-2026-08/portfolio-rule-trade-count-imbalance.md`,
`raw/archive/closed-2026-08/system-review-strategy-optimization.md`). Exact
...
- A real performance-weighting function already exists —
  ...
  `raw/archive/closed-2026-08/system-review-strategy-optimization.md`, its output isn't what
