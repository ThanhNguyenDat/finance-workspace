...
- **Round 266 (2026-08-29) — LẤY MẪU XUYÊN VÒNG HOẠT ĐỘNG (nên chính `/loop` có thể
  ...
  **NÓ HOẠT ĐỘNG — với `entry_score`:** binance BTC −0,1707 → **−0,1278** (đổi);
  ...
  tại **`raw/researcher/signal-state-samples.csv`**, seed sẵn 4 mẫu của r265 và 4
...
- **Round 267 (2026-08-29) — `trend_score` KHÔNG THỂ đổi nhanh hơn 1h **do CẤU
  ...
  **GIỐNG HỆT trên cả bốn route**: **ENTRY = 5m/15m/30m; TREND = 1h/2h/4h/12h/1d**.
  ...
  `raw/researcher/signal-state-samples.csv` nay có **12 quan sát** (vòng 265/266/267).
...
- **Round 269 (2026-08-29) — XÁC MINH r268 Ở INTERVAL PRODUCTION 5m; và route có
  ...
  **LOG LẤY MẪU VÀ MỘT PHẢN VÍ DỤ TÔI KHÔNG NGỜ TỚI:** mẫu thứ tư đã append;
  `raw/researcher/signal-state-samples.csv` nay có **16 quan sát** (vòng
...
- **Round 270 (2026-08-29) — BẤT ĐỐI XỨNG CỦA GATE là THẬT về THIẾT KẾ nhưng KHÔNG
  ...
  **NHƯNG NÓ KHÔNG RÀNG BUỘC THEO CÁCH ĐÓ:** trên toàn bộ **20 mẫu** hiện có trong
  `raw/researcher/signal-state-samples.csv` (vòng 265/266/267/269/270),
...
- **Round 271 (2026-08-29) — KHÔNG có counter kết quả nào tồn tại, nhưng `position`
  ...
  **`stale_timeframe_evidence:15m`** — một reason **KHÔNG thuộc ba gate** trong
  ...
  append-only mới: **`raw/researcher/position-state-samples.csv`**.
...
- **Round 307 (2026-08-30) — NO-CHANGE: CƠN HẠN TOÀN FLEET LÀ **SÁU VỊ THẾ ĐANG MỞ VÀ
  ...
  **KHÔNG claim:** rằng cơn hạn là **bình thường hay bất thường** — nó **được GIẢI
  ...
  vào `raw/researcher/position-state-samples.csv` và
  `raw/researcher/signal-state-samples.csv`. File:
...
Chi tiết: `raw/researcher/round346-REJECTED-dropping-the-protective-band-is-profitable-at-300-days-and-worse-at-900-and-the-gap-fill-risk-is-quantified-small.md`.
...
artifact repo-relative dưới `raw/` · repo lock: `finance-live-action`.
...
Chi tiết: `raw/researcher/round367-REJECTED-no-band-hold-setting-is-both-profitable-and-at-target-3-the-break-even-frequency-is-25-percent-below-the-bar.md`.
...
Chi tiết: `raw/researcher/round366-NEEDS-MORE-RESEARCH-the-profitable-corner-transfers-to-binance-btc-and-every-profitable-configuration-ever-found-fails-target-3.md`.
...
Chi tiết: `raw/researcher/round365-NEEDS-MORE-RESEARCH-band-and-hold-compose-super-additively-into-the-first-positive-pnl-at-deployed-costs.md`.
...
Chi tiết: `raw/researcher/round364-REJECTED-per-trade-economics-are-not-constant-across-band-settings-the-wide-band-trades-62-percent-better.md`.
...
Chi tiết: `raw/researcher/round363-REJECTED-the-hold-lever-shrinks-the-loss-by-trading-less-and-its-endpoint-is-no-activity-not-profit.md`.
...
Chi tiết: `raw/researcher/round362-NEEDS-MORE-RESEARCH-the-hold-ladder-saturates-on-btc-but-not-on-xau-where-144-still-gains-30-percent.md`.
...
Chi tiết: `raw/researcher/round361-NEEDS-MORE-RESEARCH-the-hold-lever-transfers-to-exness-xau-at-36-percent-on-a-validity-gated-same-window-test.md`.
...
Chi tiết: `raw/researcher/round360-DATA-ISSUE-cross-round-comparisons-drift-and-legacy-is-a-free-drift-control-the-hold-ladder-saturates-at-72.md`.
...
Chi tiết: `raw/researcher/round359-NEEDS-MORE-RESEARCH-the-minimum-hold-lever-cuts-losses-42-percent-and-cannot-be-validated-on-holdout.md`.
...
Chi tiết: `raw/researcher/round358-REJECTED-the-guard-is-immaterial-only-on-exness-xau-it-moves-binance-btc-by-41-percent.md`.
...
Chi tiết: `raw/researcher/round357-DATA-ISSUE-the-live-trade-log-holds-1-to-6-closes-so-it-cannot-validate-any-backtest-rate.md`.
...
Chi tiết: `raw/researcher/round356-DATA-ISSUE-the-daily-profit-gate-omits-the-construction-guard-and-the-risk-layer-so-it-scores-a-different-configuration.md`.
...
Chi tiết: `raw/researcher/round355-REJECTED-the-weekday-lead-closes-a-permutation-test-puts-negative-in-all-three-thirds-at-p-0-60.md`.
...
Chi tiết: `raw/researcher/round354-REJECTED-the-weekday-pattern-inverts-on-btc-routes-and-my-registered-criterion-was-vacuous.md`.
...
Chi tiết: `raw/researcher/round353-NEEDS-MORE-RESEARCH-wednesday-is-negative-in-three-disjoint-periods-but-the-hypothesis-was-not-fresh.md`.
...
Chi tiết: `raw/researcher/round352-NEEDS-MORE-RESEARCH-every-holdout-in-this-arc-is-nested-so-no-two-windows-are-independent-and-the-weekday-signal-is-half-replicated.md`.
...
Chi tiết: `raw/researcher/round351-DATA-ISSUE-the-interval-flag-does-not-change-the-portfolio-decision-interval-and-the-replay-is-bit-for-bit-deterministic.md`.
...
Chi tiết: `raw/researcher/round350-REJECTED-unlocking-reversals-does-not-explain-the-gain-the-cost-slope-does-and-the-gate-if-anything-hurts.md`.
...
Chi tiết: `raw/researcher/round349-NEEDS-MORE-RESEARCH-the-replay-blocks-102-reversals-at-deployed-costs-and-3-when-unlocked.md`.
...
Chi tiết: `raw/researcher/round348-DATA-ISSUE-the-cost-flags-move-reversals-across-a-10bps-gate-which-explains-rounds-344-345-and-346.md`.
...
Chi tiết: `raw/researcher/round347-NO-CHANGE-binance-kline-revisions-are-real-but-median-zero-bps-with-a-2-9-bps-tail.md`.
...
Chi tiết: `raw/researcher/observability-trace-audit-production-logs-verify-causality-and-expose-two-backtest-live-divergences.md`.
...
Checklist kiểm chứng cho người implement nằm trong báo cáo: `raw/researcher/backtest-correctness-audit-look-ahead-and-fill-invariants.md`.
...
Chi tiết: `raw/researcher/round345-REJECTED-the-cost-feedback-is-not-a-threshold-a-0-1-bps-fee-change-moves-gross-15-percent-and-the-replay-is-chaotic.md`.
...
Chi tiết: `raw/researcher/round344-DATA-ISSUE-the-cost-flags-change-the-decision-stream-so-cost-component-attribution-is-not-identified.md`.
...
Chi tiết: `raw/researcher/round343-NO-CHANGE-exness-xau-gross-is-positive-across-four-windows-and-the-gold-decorrelation-is-a-deliberate-ensemble-difference.md`.
...
Chi tiết: `raw/researcher/round342-NEEDS-MORE-RESEARCH-the-two-gold-routes-track-each-other-at-0-996-in-price-and-0-287-in-portfolio-pnl.md`.
...
Chi tiết: `raw/researcher/round341-REJECTED-the-trough-does-not-replicate-on-a-different-window-and-single-day-dominance-is-general-with-gold-inverting-between-venues.md`.
...
Chi tiết: `raw/researcher/round340-NEEDS-MORE-RESEARCH-the-hole-is-a-smooth-unimodal-trough-across-seven-bands-and-one-day-dominates-every-configuration.md`.
...
Chi tiết: `raw/researcher/round339-NEEDS-MORE-RESEARCH-the-gross-dip-at-the-deployed-band-is-real-not-noise-and-production-sits-inside-a-narrow-hole.md`.
...
Chi tiết: `raw/researcher/round338-REJECTED-the-cross-route-frequency-gross-pattern-does-not-survive-a-within-route-ladder-and-bybit-xaut-does-have-gross-edge.md`.
...
Chi tiết: `raw/researcher/round337-REJECTED-continuity-follows-the-instruments-trading-calendar-not-the-venue-and-every-gate-eligible-route-has-negative-gross.md`.
...
Chi tiết: `raw/researcher/round336-DATA-ISSUE-exness-xau-can-never-pass-the-gate-at-any-window-and-binance-btc-is-the-first-gate-eligible-route-measured.md`.
...
Chi tiết: `raw/researcher/round335-DATA-ISSUE-no-500-day-exness-xau-run-can-pass-the-gate-and-the-band-optimum-is-a-plateau-not-a-point.md`.
...
Chi tiết: `raw/researcher/round334-REJECTED-the-6-8-per-week-coincidence-dissolves-on-a-refined-grid-and-the-volatility-prediction-locates-the-band.md`.
