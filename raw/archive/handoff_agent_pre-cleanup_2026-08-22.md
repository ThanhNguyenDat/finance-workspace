...
- **[Repository docs][P3, requested 2026-08-22] Rename `raw/handoff_codex.md` → `raw/handoff_agent.md`, push the 5 doc reference updates:** details → `raw/explain/handoff-rename-2026-08-22.md`.
...
- **[Bug][P1, found 2026-08-22, Claude round 84 `/loop`] `finance-research`
  ...
  **Fix already implemented and verified locally** (build clean, `cargo test
  ...
  `raw/researcher/round84-portfolio-risk-policy-widening-missing-in-research-tool.md`.
...
- **[Trading][P4 — lead nghiên cứu, user hỏi trực tiếp 2026-08-21, chưa
  ...
  research (83+ round, mọi file `raw/researcher/round*.md` +
...
- **[Trading][P1 — round 65 tìm ra nguyên nhân thật: bất đối xứng subscription
  ...
  **[Claude round 63 `/loop`, 2026-08-21 — tìm được CƠ CHẾ cụ thể, nâng độ tin
  ...
  `raw/researcher/round63-binance-xau-interval-weight-mechanism.md`.
...
- **[Trading][P3 — cải thiện tương đối, chưa đủ để fix Target 1, ghi nhận
  ...
  **NHẤT QUÁN cả 3 split VÀ cả 2 instrument** (BTC: 0.677/0.660/0.625 →
  ...
  trong `raw/researcher/round58-rsi_14_20_80-consistent-improvement-cross-instrument.md`.
...
- **[Trading][P1 — số liệu THẬT đầu tiên qua engine đúng, không phải task
  ...
  `raw/researcher/round55-real-production-gate-and-tool-overhaul.md`.
...
- **[Trading][meta, không phải task riêng] Tổng hợp ưu tiên chương trình
  ...
  2026-08-20):** `raw/researcher/SUMMARY-priority-backlog.md` — đọc file
  ...
  **Đề xuất rẻ nhất, không cần code switching mới:** đăng ký 2-3 biến thể
  ...
  `raw/researcher/round36-complementary-regime-sensitivity-baseline-vs-adx.md`.
  ...
  **[NÂNG MỨC TIN CẬY MẠNH — Claude round 51 /loop, 2026-08-20, proof-of-
  ...
  `raw/researcher/round51-ensemble-proof-of-concept-major-improvement.md`.
...
- **[Trading][P2 — đề xuất signal mới từ web research, chưa implement, cần
  ...
  `raw/researcher/round22-funding-rate-extreme-reversion-proposal.md`. Chưa
  ...
  **[NÂNG ƯU TIÊN — Claude round 42 /loop, 2026-08-20, đã tự validate giả
  ...
  `raw/researcher/round42-funding-rate-hypothesis-validated-external-data.md`.
  ...
  **[HẠ MỨC ƯU TIÊN LẠI — Claude round 44 /loop, 2026-08-20, out-of-sample
  ...
  trong `raw/researcher/round42-funding-rate-hypothesis-validated-external-data.md`
...
- **[Trading][P2 — đề xuất kiến trúc mới, chưa implement, số liệu thật kèm
  ...
  `raw/researcher/round17-swing-4h1d-regime-filter-family.md` và
  ...
  **Kết quả: đổi base 4h→5m (nhỏ hơn 48 lần) chỉ tăng tần suất 0.34→0.55
  ...
  `raw/researcher/round19-mtf-frequency-bottleneck-mechanism.md`.
  ...
  **2026-04-12 → 2026-05-29**, xác nhận cross-broker (Exness BTC/USD cùng
  ...
  `raw/researcher/round35-losing-streak-dates-pinpointed.md`.
...
- **[Data quality][historical context for active Processing task, not a separate Todo]
  ...
  **[Claude independent backtest, round 18 `/loop`, 2026-08-20]** Tự build
  ...
  đầy đủ trong `raw/researcher/round18-vwap-orb-independent-test.md` và
  `raw/reports/optimize_loop_update_v2.csv`:
  ...
  **Exness BTC fail continuity ở 5 interval (5m/15m/1h/2h/30m); Exness XAU
  ...
  tiết trong `raw/researcher/round56-full-4leg-production-gate-picture.md`.
  ...
  **[Claude cross-instrument test round 21 /loop, 2026-08-20]** Test đúng 4
  ...
  `raw/researcher/round21-continuity-fix-verify-and-btc-orb-transfer.md`.
  ...
  **2.014**/holdout **0.683 (thua)**; ORB 60m: train 1.065/validation
  ...
  trong `raw/researcher/round34-orb-30m-falsified-regime-dependency-test.md`.
...
- **Portfolio profitability practices (Claude system review):** Round 2 đã
  ...
  `raw/proposal/portfolio-profitability-improvements.md`; vòng actionable hiện
...
- **[Trading][P2/P3, Claude verify → Done, round 54 /loop, 2026-08-21]
  ...
  **[Claude independent verify, round 54 /loop, 2026-08-21]** Tự xác nhận:
  ...
  `raw/researcher/round54-CORRECTION-real-decide-engine-invalidates-manual-backtest.md`
  và `raw/researcher/SUMMARY-priority-backlog.md`. Cảm ơn Codex đã tự fix
...
- **[English] Notion English review → Telegram (Claude implement+deliver,
  ...
  đã viết ở `raw/proposal/notion-english-review-telegram.md` — job mới chạy
