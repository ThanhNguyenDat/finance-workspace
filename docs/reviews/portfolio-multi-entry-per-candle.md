...
- `fixed-pct` and `compounding-10pct` both report **169 closed trades total**,
  ...
  `docs/archive/legacy-raw/archive/closed-2026-08/portfolio-rule-trade-count-imbalance.md`'s note that all 3 rules
...
2026-08-09 (`docs/archive/legacy-raw/archive/closed-2026-08/portfolio-rule-trade-count-imbalance.md`), yet the journal
