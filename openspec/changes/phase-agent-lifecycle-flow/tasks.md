...
- [x] 7.1 Update applicable orchestration rules/skills with session leases, worktree scopes, SQLite recovery, quota continuation and archive gates; verify `uv run --project tools/phase-agent-orchestrator sync-agent-links --check`.
