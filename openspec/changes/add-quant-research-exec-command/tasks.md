...
- [ ] 1.2 Add a helper that scans `research/quant/rounds/round<N>-*.md`
...
- [ ] 2.1 Add `src/orchestrator/cli/quant_research_exec.py` with
...
- [ ] 2.2 Wire round-number resolution per role: `--role implement` uses
...
- [ ] 2.3 Derive `change = f"quant-research-round-{round}"` and pass it into
...
- [ ] 2.4 Assemble the final prompt (task 1.1's body + `\n\n## This round's
      ...
      turn.
- [ ] 2.5 Register the `quant-research-exec = "orchestrator.cli.
...
- [ ] 3.1 Add a `### quant-research-exec` section to
...
- [ ] 3.2 Update `.claude/commands/quant/research.md`'s Bước 3 and Bước 7
