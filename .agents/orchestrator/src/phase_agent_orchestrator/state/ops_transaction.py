...
from ..io import CLIError, atomic_write_json, die, json_text, utc_now
...
def trace_origin(change: str, session_id: str, iteration: str, instrument: str, artifacts: list[str]) -> None:
    ...
    for name, label in (("proposal.md", "proposal"), ("design.md", "design"), ("tasks.md", "tasks")):
    ...
    approved = tuple(root_canonical / item for item in ("research/quant/rounds", "research/quant/studies", "research/quant/audits", "research/quant/samples", "research/quant/reports"))
