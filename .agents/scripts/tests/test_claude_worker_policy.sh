...
grep -Fq 'permission_mode="bypassPermissions"' "$ROOT_DIR/tools/orchestrator/src/orchestrator/runners/phase_adapter.py" || { printf 'test_claude_worker_policy: SDK permission bypass missing\n' >&2; exit 1; }
