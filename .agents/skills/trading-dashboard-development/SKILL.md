...
description: Build, validate, deploy, and verify Finance MW trading dashboard changes that consume Finance Live Action metrics and trade history without falsifying ledger or broker semantics.
---
